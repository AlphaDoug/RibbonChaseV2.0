...
namespace FlightKit
{
	...
	public class StartLevelController : MonoBehaviour
    {
        ...
        private IEnumerator StartLevelCoroutine()
        {
            ...
            MonoBehaviour userControl_Joy = _airplane.GetComponent<AirPlaneJoystickController>();
            if (userControl == null)
            {
            ...
            if (userControl_Joy == null)
            {
                Debug.LogError("Can't find AirPlaneJoystickController component on the airplane.");
                yield break;
            }
